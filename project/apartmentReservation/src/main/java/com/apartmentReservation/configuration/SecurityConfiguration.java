//This class takes care of page redirection,authentication,session handling.
...
//This method takes care of authentication
 ...
 //This method takes care of page redirection.
 protected void configure(HttpSecurity http) throws Exception{
	  ...
	  .antMatchers("**").permitAll()
	   ...
	   .antMatchers("/viewProperties").permitAll()
	   .antMatchers("/statusupdate").permitAll()
	...
	//This method is for persistent connection to database.
	 @Bean
